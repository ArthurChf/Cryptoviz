<template>
    <div>
        ...
        <Transition :name="TransitionEnum.FADE">
            <div v-if="search.length" class="z-50 select-none absolute top-[43.4px] left-[1.9px] w-40 flex flex-col rounded-b-md flex-nowrap overflow-x-auto scrollbar bg-slate-950 overflow-y-auto scrollbar max-h-32 text-sm">
